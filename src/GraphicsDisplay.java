...
// Перо для рисования графика
        float[] dash = {20,5,10,5,5,5,10,5,20};
...
// Отобразить график
    ...
    protected void paintMarkers(Graphics2D canvas) {
        ...
        for (Double[] point : graphicsData) {
            ...
            // Вершины треугольника (замените значения на те, которые вам нужны)
            int x1 = (int) center.getX();
            int y1 = (int) center.getY() + 3;  // Вершина выше центра
            int x2 = (int) center.getX() + 5;  // Левая вершина
            int y2 = (int) center.getY() - 6;
            int x3 = (int) center.getX() - 5;  // Правая вершина
            int y3 = (int) center.getY() - 6;

            // Добавляем вершины к треугольнику
